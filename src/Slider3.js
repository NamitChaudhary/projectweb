...
import first from './images/RIS1.svg'
import second from './images/RIS2.svg'
            ...
            <div className='backcolor'>
                <div className="container p-t-b-8">
                    <div className='introducing-block '>
                        <div className="row p-5 slider3 box-mob-slider">
                            <div className="col-md-6 col-12 box-md-size">
                                <h6 className='css6'>Introducing </h6>
                                <h3 className='css5'>Cloud LIS & RIS</h3>
                                <h6 className='css7'>1- Increase staff productivity. </h6>
                                <h6 className='css7'>2- Improves operational effectiveness</h6>
                                <h6 className='css7'>3- Enhances quality of care</h6>
                                <h6 className='css7'>4- Seamlessly manage Patient & Image tracking to improve operational efficiency.</h6>
                                <h6 className='css7'>5- streamline multiple workflow management within the Department.</h6>
                                <div className='css8'>
